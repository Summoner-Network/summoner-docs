...
| **extension-agentclass** | Native module that adds security and orchestration features to `SummonerClient`.       | Python                  | repo-specific                             | Use self-signed agent identity and cryptographic envelopes in your agents. | Apache-2.0 |
